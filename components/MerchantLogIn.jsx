            ...
            <div className='bg-white  w-[30%] pb-7 rounded-md'>
                ...
                <form action="" className='mt-7'>
                    ...
                    <div className='w-full px-11'>
                        ...
                        <input id={'email'} type={'text'} className='placeholder:text-[#999999] placeholder:text-xl placeholder:font-normal mt-2 h-12 w-full text-base font-medium bg-white border border-[#CCCCCC] rounded-sm pl-6' placeholder='Add Email Address'/>
                    </div>
                    
                    <div className='relative w-full px-11 mt-7'>
                        <label htmlFor={'merchPass'} className='text-xl font-normal text-[#222222]'>Password</label>
                        <input id={'merchPass'} type={showPass ?  "password" : "text"} className='placeholder:text-[#999999] placeholder:text-xl placeholder:font-normal mt-2 h-12 w-full text-base font-medium bg-white border border-[#CCCCCC] rounded-sm pl-6' placeholder='Add Password'/>
                    ...
                    <div className='mt-8 w-full flex justify-center'>
                        <button className='bg-[#0079E9] text-white py-4 px-28 font-bold text-lg rounded-sm'>LOG IN</button>
                    </div>
                </form>
