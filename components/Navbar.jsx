...
const Navbar = () => {
  return (
    <nav className='flex justify-between items-center h-24 px-12'>
        <Link href={'/'}>
            <img src="./assets/images/home/baldgenie.png" alt="logo" className='h-10' />
        </Link>
        
        <div className='w-2/5 h-11  drop-shadow-md '>
          <div className='h-11 flex items-center bg-white rounded-md px-3 sm:flex-wrap sm:h-auto  sm:py-4'>
            <div className='flex w-1/3 sm:w-full sm:items-center'>
              <SearchLocation/>
              <input type="text" placeholder='Detect My Location' className='text-lg px-3 w-full border-r-gray-300 border-r-2 sm:border-none sm:py-1 sm:text-base'/>
            </div>
            ...
            <div className='flex pl-3 flex-1 items-center sm:w-full sm:pl-0 sm:items-center'>
              <SearchIcon/>
              <input type="text" placeholder='Search for services' className='text-lg pl-3 w-full sm:pl-4 sm:py-1 sm:text-base'/>
            </div>
          </div>
        </div>
