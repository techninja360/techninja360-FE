...
const SingleCategory = ({name,primSvg,secSvg,hoverSvg}) => {
  ...
  return (
    <div onMouseOver={()=>setHover(true)} onMouseOut={()=>setHover(false)} className={`flex items-center relative bg-gray-100 h-[91px] w-[343px] overflow-y-hidden hover:bg-blue-600 hover:text-white`}>
